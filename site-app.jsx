...
const TWEAK_DEFAULTS = /*EDITMODE-BEGIN*/{
  ...
  "aboutHeading": "Nosy about people, in the best possible way.",
  "aboutPara1": "I'm a photographer because I can't stop watching what people do. What a face does in the half-second before a laugh. What a body looks like at the very top of a jump. Where the energy in a crowded room actually lives. Those split seconds are the whole job — everything else is preparation.",
  "aboutPara2": "The preparation part I take seriously. Years of reps have turned light, timing, and lens choice into reflexes, so when the real moment shows up, the technical stuff is already handled and I'm just paying attention. Fast hands, calm presence, no fuss.",
  ...
  "step1Body": "We hop on a call or grab a coffee. I learn what you need, we sort the where and when, and you walk away with a clear plan and a clear price.",
