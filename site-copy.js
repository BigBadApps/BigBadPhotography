...
window.SITE_COPY = {
  ...
  hero: {
    eyebrow: "Portraits · Families · Sports · Events, Minneapolis MN",
  ...
  portfolio: {
    ...
    sub: "A look at what I do. Pick a tab and poke around. Every frame here was a real moment first.",
    ...
    items: [
      {
        ...
        body:
          "The best portrait happens about four seconds after you forget I'm holding a camera. I keep sessions easy and conversational, more chatting and less posing, and I stay ready for the expression that's actually you. That's the frame we're after.",
      },
      {
        num: "02",
        title: "Families",
      ...
      },
      {
        ...
        body:
          "The shot lives in a fraction of a second. The takeoff, the contact, the release. I learn the rhythm of your sport so the lens is already aimed where the moment lands. High energy in, sharp frames out.",
      },
      {
        num: "04",
        title: "Live Events",
        kicker: "The whole story, start to finish",
        body:
          "Every event has an arc. The quiet setup, the build, the full-room peak. I work unobtrusively and keep moving, so you get complete coverage without anyone feeling photographed. Looking through the gallery should feel like being there twice.",
      },
    ],
  },
